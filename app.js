...
const stripe=require('stripe')('sk_test_51Nj1JFSHGmQYCLKVEt4aLGy0YGDYsFT4tL9UDCwolfpc9qhNLsVFAYWYplAQR4RI2nTBNdj2gOpY3EAq09BOmGbc00hrnpXXXn');
...
mongoose.connect('mongodb+srv://vishalmeena2486:Vishal123@cluster0.fmz8m0f.mongodb.net/?retryWrites=true&w=majority',{
...
app.post('/contact',requireLogin,(req,res)=>{
    ...
    new Contact(newContact).save((err,user)=>{
        if(err){
            ...
            console.log('We received meaasge from user',user);
        }
    });
});
...
io.on('connection',(socket)=>{
    ...
    socket.on('LatLng',async (data)=>{
        console.log(data);
        Car.findOne({_id:data.car._id})
        .then((car)=>{
